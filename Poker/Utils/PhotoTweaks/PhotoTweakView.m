...
//        _cropView = [[CropView alloc] initWithFrame:self.scrollView.frame];
        ...
        CGRect frame=CGRectMake((self.scrollView.frame.size.width-300)/2.0, (self.scrollView.frame.size.height-150)/2.0, 300, 300);
...
//        [_resetBtn setTitle:@"重置旋转 " forState:UIControlStateNormal];
