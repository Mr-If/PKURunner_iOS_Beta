...
- (void)commonInit
{
    ...
    {
        kuaiview=[JTCalendDayKuaiView new];
        kuaiview.color=[UIColor redColor];
        kuaiview.hidden=YES;
        [self addSubview:kuaiview];
    }
...
- (void)configureConstraintsForSubviews
{
    ...
    kuaiview.frame=CGRectMake(0, 0, sizeCircle-6, sizeCircle-6);
    kuaiview.center = CGPointMake(self.frame.size.width / 2., self.frame.size.height / 2.);
}
...
- (void)reloadData
{
    ...
    NSInteger value=[self.calendarManager.dataSource calendarHaveEventKuaiHidden:self.calendarManager date:self.date];
    ...
    kuaiview.layer.cornerRadius=5.0;
    kuaiview.layer.masksToBounds=YES;
//    kuaiview.layer.shadowRadius=5;
//    kuaiview.layer.shadowOpacity=0.8;
//    kuaiview.layer.borderWidth=1.0;
//    kuaiview.layer.shadowOffset=CGSizeMake(3, 3);
//    kuaiview.layer.shadowColor=[UIColor blackColor].CGColor;
    
    if (value==1) {
//        kuaiview.layer.borderColor=[UIColor greenColor].CGColor;
        kuaiview.color=[UIColor colorFromHexString:@"ffa397"];
    }
    
    if (value==2) {
//        kuaiview.layer.borderColor=[UIColor purpleColor].CGColor;
        kuaiview.color=[UIColor colorFromHexString:@"ffe897"];
    }
    
    if (value==3) {
//        kuaiview.layer.borderColor=[UIColor blueColor].CGColor;
        kuaiview.color=[UIColor colorFromHexString:@"ff5d47"];
    }
